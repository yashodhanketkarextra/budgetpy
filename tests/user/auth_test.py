...
class TestAuthentication:
    def test_successfull_login(self, auth_token, db_session):
        assert auth_token is not None

    def test_get_me_with_jwt(self, auth_token, client, db_session):
...
class TestLoginFailures:
    def test_login_unregisterd_user(self, client, db_session):
